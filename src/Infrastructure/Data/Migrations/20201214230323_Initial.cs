        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserIdAsking = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserIdAnswering = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateTimeQuestion = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearOfWriting = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    YearPublishing = table.Column<string>(type: "nvarchar(max)", nullable: true),
